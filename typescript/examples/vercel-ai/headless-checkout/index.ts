...
import { crossmintHeadlessCheckout } from "@frog-sdk/plugin-crossmint-headless-checkout";
...
(async () => {
    ...
    const result = await generateText({
        ...
        tools: tools,
        maxSteps: 5,
        prompt: `Buy productId 'frog_COAL'from crossmint collection 'crossmint:${MY_CROSSMINT_COLLECTION_ID}', the total price should be 1 usdc`,
    });
