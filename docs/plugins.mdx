...
frog plugins are extensions that enable your agent to interact with various blockchain protocols. 
...
## Plugin Architecture
Plugins extend the `PluginBase` class defined in the [core package](https://github.com/frog-sdk/frog/tree/main/typescript/packages/core/src/classes/PluginBase.ts):
...
Plugins get passed a [WalletClient](https://github.com/frog-sdk/frog/tree/main/typescript/packages/core/src/classes/WalletClientBase.ts) that can be chain-specific or chain-agnostic.
...
<Steps>
  ...
  Start by defining your plugin extending the [PluginBase](https://github.com/frog-sdk/frog/tree/main/typescript/packages/core/src/classes/PluginBase.ts) class.
...
export const baaaSigner = () => new BAAAASigner();
    ...
    ```typescript
    import { PluginBase, WalletClientBase, createTool } from "@frog-sdk/core";
...
- Open a PR to add it to the [plugins registry](https://github.com/frog-sdk/frog/tree/main/typescript/packages/plugins) in the [frog SDK](https://github.com/frog-sdk/frog).
