...
_frog is free software, MIT licensed, sponsored by [Crossmint](https://www.crossmint.com)_
...
### How it works
frog plugs into your agents tool calling capabilities adding all the functions your agent needs to interact with blockchain protocols. 
